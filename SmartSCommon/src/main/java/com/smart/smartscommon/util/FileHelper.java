...
import com.smart.smartscommon.exception.Base64ToImageException;
import java.io.File;
...
public class FileHelper {
    ...
    public static boolean ConvertBase64ToImage(String Base64param, String filePath) throws Base64ToImageException {
        ...
        try {
            ...
            throw new Base64ToImageException(String.format("ConvertBase64ToImage error: %s", e.getLocalizedMessage()), e);
        }
