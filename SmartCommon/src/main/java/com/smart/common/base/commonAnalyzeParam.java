...
import com.smart.common.model.ParamBaseModel;
...
public class commonAnalyzeParam {
    ...
    public ParamBaseModel AnalyzeParamBase(String param) throws Exception {
        ...
        try {
            ...
            if (baseModel.jsonHead.containsKey(DeployInfo.paramRSIDKey)) {
                this.setRSID(baseModel.jsonHead.getString(DeployInfo.paramRSIDKey));
            }
            if (baseModel.jsonHead.containsKey(DeployInfo.paramtokenKey)) {
                this.setToken(baseModel.jsonHead.getString(DeployInfo.paramtokenKey));
            }
            ...
            RSLogger.ErrorLogInfo("AnalyzeParamBase IAnalyzeReviceParamModel error.strParam:" + param + e.getLocalizedMessage());
        ...
        try {
            ...
            switch (content) {
                ...
                case "values":
                    ...
                    break;
                default:
                    RSLogger.ErrorLogInfo("AnalyzeParamToMap error ,invalid content.:" + content + param);
                    throw new Exception("AnalyzeParamToMap error ,invalid content." + content);
            }
            if (objSourceTemp == null) {
                RSLogger.ErrorLogInfo("AnalyzeParamToMap error , content is null.:" + content + param);
