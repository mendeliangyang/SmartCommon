...
import com.smart.common.model.DataBaseTypeEnum;
import com.smart.common.model.DBDetailModel;
import com.smart.common.model.ReviveRSParamModel;
import com.smart.common.model.SqlFactoryResultModel;
import com.smart.common.model.TableDetailModel;
...
//        return DBHelper.ASAConnect(setModel.dbUser, setModel.dbPwd, setModel.dbAddress, setModel.dbName, setModel.dbPort);
    ...
    public static String SqlSelectPageFactory(ReviveRSParamModel paramModel) throws Exception {
        ...
        try {
            ...
            tempTableName = String.format("#t_%s%s%s", paramModel.db_tableName, UtileSmart.getCurrentDateSecond(), UtileSmart.getRandomStrbySeed(99));
    ...
    public static ExecuteResultParam ExecuteSqlSelect(String rsid, String sqlStr) throws Exception {
        ...
        try {
            ...
            //e.printStackTrace();
            RSLogger.ErrorLogInfo("ExecuteSqlSelect err sql:" + sqlStr, e);
            return new ExecuteResultParam(-1, e.getLocalizedMessage());
        } finally {
